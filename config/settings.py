...
RAW_DATA_DIR = os.path.join(DATA_ROOT, "external", "gtzan", "Data", "genres_original")
...
AUDIO_DURATION = 20  # Fixed duration for audio clips (seconds)
...
TRAIN_VAL_SPLIT = (
    0.8  # Ratio for training set (e.g., 0.8 for 80% train, 20% validation)
)
...
CLASSIFIER_TYPE = (
    "logistic_regression"  # Only Logistic Regression for now, others as TODO
)
